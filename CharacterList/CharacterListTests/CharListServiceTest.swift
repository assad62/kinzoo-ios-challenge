...
final class CharListServiceTests: XCTestCase {
    private var cancellables: Set<AnyCancellable>!
    var sut:CharListDecorator?
    var data:CharListDTO?
    var error: Error?
    ...
    func test_success_condition(){
        ...
        let response = sut?.loadList(request: URLRequest(url: URL(string: "https://www.mytesturl.com")!))
